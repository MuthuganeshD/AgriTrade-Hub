...
<html lang="en">
	...
	<style>
		body{
			background: linear-gradient(rgba(170,0,0,0.2),rgba(0,170,0,0.2));
		}
	</style>
	...
	?>
		...
		<!-- Banner -->
			<section id="banner" class="wrapper">
				<div class="container">
				<h2 style="color:red;">AgroTrade Hub</h2>
		...
		<!-- One -->
			<section id="one" class="style1 align-center" style="background-color:white">
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive; ">AgroTrade Hub &#169; </h3>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">AgroTrade Hub<span>Chennai</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">9478452196</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:agroTra@gmail.com" style="color:white">demo@demo.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About AgroTrade Hub</b></span>
				AgroTrade Hub is e-commerce trading platform for grains & grocerries...
			</p>
