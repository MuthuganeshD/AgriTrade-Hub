	...
	<body class="subpage">
		...
		?>
			...
			<section id="main" class="wrapper">
				<div class="inner">
					<div class="container" style="width: 70% color:red">
					<div class="row uniform">
						<div class="9u 12u$(small)">

						</div>
						<div class="3u 12u$(small)">
							<a href="blogWrite.php" class="button special fit" style="background-color:#f44336;"><span class="glyphicon glyphicon-pencil"></span> Feedback</a>
						</div>
					</div>
					<br />
					<?php
						...
						<form method="post" action="blogView.php">
							<div class="row">
								<div class="6u 12u$(xsmall)">
									<button class = "button primary small"  style="background-color:blue" name="<?php echo 'like'.$id; ?>">
