...
<html lang="en">
	<head>
		<meta charset="UTF-8">
		<title>AgroTrade Hub: My Cart</title>
	...
	<body style="background-color:whhite">
				...
				<div class="container">
					...
					<?php
						...
						?>
							...
							<a href="review.php?pid=<?php echo $row1['pid'] ;?>" > <img class="image fit " style="width:200px" src="<?php echo $picDestination;?>" alt=""  /></a>

							<div style="align: left;font-size:bold">
