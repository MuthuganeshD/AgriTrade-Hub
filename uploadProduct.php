	...
	<body>
		...
		<!-- One -->
			...
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<form method="POST" action="uploadProduct.php" enctype="multipart/form-data">
						...
						<br>
				<center>
					<input type="file" name="productPic"  style="color: white;"></input>
					<br />
				</center>
				<div class="row">
					  <div class="col-sm-6">
				...
				<br>
				<div>
				<input type="text" name="pinfo" id="pinfo" value="" placeholder="Product Description" style="background-color:white;color: black;" />
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<button class="button fit" style="width:auto;background-color:gray;">Submit</button>
				</div>
			</div>
			</form>
		</div>
